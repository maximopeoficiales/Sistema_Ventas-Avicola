Public Class Factura2
    ...
    Private Sub mostrar_datos()
        ...
        For Index = 0 To RegistrarVentas.list.Items.Count - 1
            With lista_factura.Items.Add(RegistrarVentas.list.Items(Index).SubItems(0).Text)
        ...
        'datos de txt'
        txt_nfactura.Text = rg.label_n_factura.Text
        txt_direccion.Text = rg.txt_direccion.Text
        txt_ruc.Text = rg.txt_dni.Text
    ...
    Private Sub Factura2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        mostrar_datos()
    End Sub
